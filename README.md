[![Build Status](https://dev.azure.com/stuebersystems/Websites/_apis/build/status/docs/doc.la.de?branchName=master)](https://dev.azure.com/stuebersystems/Websites/_build/latest?definitionId=53&branchName=master)
![Deployment status](https://vsrm.dev.azure.com/stuebersystems/_apis/public/Release/badge/2cc87afa-9a3b-472b-8a3c-3eca48b22dd6/7/8)

# Dokumentation zu Landesanpassungen

Dies ist die deutsche Dokumentation zu den Landesanpassungen von [Magellan](https://magellan.stueber.de) und [DaVinci](https://davinci.stueber.de). Die Dokumentation ist Open Source und wir haben sie mit [MkDocs](https://www.mkdocs.org) und [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) realisiert. 
...
1. Erstelle einen lokalen Ordner für die Dokumentation, z.B. `c:\docs\la`.

2. Starte die Eingabeaufforderung und wechsle in den Ordner `c:\docs\la`.

3. Tippe den Befehl `git clone https://github.com/stuebersystems/doc.la.de.git` ein, um das Repository zu klonen.
...
1. Öffne die URL `https://github.com/stuebersystems/doc.la.de` in deinem Webbrowser

2. Klicke auf die Schaltfläche `Clone or download` und dann auf `Download ZIP`.

3. Entpacke das Zip-Archiv in einen lokalen Ordner Deiner Wahl, z.B. `c:\docs\la`.
...
1. Starte die Eingabeaufforderung und wechsle in den Ordner `c:\docs\la`.
