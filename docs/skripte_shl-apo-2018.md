...
1. Legen Sie unter `Verzeichnisse > weitere Schlüsselverzeichnisse > Sprachreferenzen` folgenden Werte an:
...
![Verzeichnis Sprachreferenzen](/assets/images/SHL/SHL_APO_2018_Sprachreferenzen.png)
   ...
   2. Ihre Fremdsprachen müssen im Verzeichnis der Fächer mit den statitistikrelevanten Schlüsseln befüllt sein. Aktuell werden folgende Schlüssel verwendet:
