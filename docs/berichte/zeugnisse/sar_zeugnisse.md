...
Betragen, Mitarbeit, Arbeitshaltung und Teamfähigkeit usw. legen Sie im Schlüsselverzeichnis > Fächer an. Weisen Sie diese dem Schüler im Menü Schüler > Zeugnis > Fächer zu. Zusätzlich erhalten die Fächer im Feld "Fachstatus" den Eintrag "VHZ" zu. Grundlage für das Zuweisen eines Fachstatus bildet das Schlüsselverzeichnis > Fachstatus. Beachten Sie dabei auch die Merkmale A0015 und A0015.98.
Die Reihenfolge der Fächer auf dem Zeugnis richtet sich nach der Positionsnummer, die Sie dem jeweiligen Fach in der Spalte „Position“ vergeben haben. Die Noten der Fächer tragen Sie im Menü Schüler > Zeugnis > Leistungen in der Spalte „Endnote“ ein. Grundlage bildet das Schlüsselverzeichnis > Noten. Beachten Sie dabei, dass bei einer 4 nicht die Notenbezeichnung sondern die Bezeichnung "nicht befriedigend" ausgegeben wird.
...
Kürzel |  Schlüssel | Zeugnisbereich
--|--|--
E | E | Erweiterungs- und Ergänzungskurs
...
Das Zeugnis kann sowohl Halbjahres- und Jahreszeugnis sein. Maßgebend ist der Eintrag im Schlüsselverzeichnis > Zeiträume in Spalte „Art“ 1. Halbjahr oder 2 Halbjahr.
Weiterhin können Sie das Zeugnis für die Klassen 5-8 nutzen. Die unterschiedlichen Inhalte ergeben sich aufgrund des eingetragenen Jahrganges im Menü Klassen > Zeiträume > Zeitraum im Feld "Jahrgang".
...
**(A0019.58)** In der Spalte „Unterrichtsart“ ist der Wert „Profil“ für die Fächer des Profilbereiches zu verwenden, den Sie im Verzeichnis „Unterrichtsarten“ wie folgt definieren:
...
## Archiv | SAR-FHReife (Nachweis - G8).rpt
...
**(A0540)** Mandanten > Daten 1 > Kategorie

Tragen Sie im Menü Mandanten > Daten 1 im Feld „Kategorie“ Ihre Schulform ein. Grundlage hierfür bildet das Schlüsselverzeichnis > Kategorien (Mandanten). Das Zeugnis prüft den Eintrag "Kürzel".

Kürzel | Schlüssel | Bezeichnung
--|--|--
Gym | beliebig | Gymnasium
Gem | beliebig | Gemeinschaftsschule

**(A0604)** Abitur > Qualifikation > Fachhochschulreife berechnen

Bei dem "Zeugnis über den Nachweis des schulischen Teils der Fachhochschulreife" berechnet Ihr Skript, ob die Fachhochschulreife erreicht wurde oder nicht. 
...
## Archiv | SAR-FHReife (Nachweis - G9).rpt
