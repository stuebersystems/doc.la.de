...
## Klassenleitung, Schulleitung, Deinstbezeichnung
...
Die Schulleitung muss im entsprechenden Zeitraum unter `Mandanten > Daten1` im Feld "Schulleiter" eingetragen werden.

### Klassenleitung

`Klassen > Zeiträume > Zeitraum > Klassenleiter`

Die Klassenleitung muss im entsprechenden Zeitraum im Menü `Klassen > Zeiträume` bei der jeweiligen Klasse im Feld "Klassenleiter" eingetragen werden.
...
Die stellv. Klassenleitung muss im entsprechenden Zeitraum im Menü `Klassen > Zeiträume` im Feld „Klassenleiter 2“ eingetragen werden.
