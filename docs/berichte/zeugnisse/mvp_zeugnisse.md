...
**A0015.52** Kürzel | Schlüssel | Zeugnisbereich
--|--|--
...
**A0019.71** Kürzel | Schlüssel | Zeugnisbereich
--|--|--
L-Kurs | L  | Leistungskurse (L-Kurse), Kurse auf erhöhtem Anforderungsniveau"

**A0019.72** Kürzel | Schlüssel | Zeugnisbereich
--|--|--
...
**A0940** `Extras > Schlüsselverzeichnisse > Fächer > Zeugnismerkmal`
...
## MVP-FG-FHReife (Bescheinigung 2020).rpt
...
**(A0003.4)** Kürzel  | Schlüssel  | Bezeichnung
--|--|--
KS |  KS |  Kurzschrift
...
## MVP-GS-HJZ (Jahrgangsstufe 2-4).rpt
...
## MVP-GS-ÜZ (Jahrgangsstufe 2-4).rpt
...
## MVP-GY (Studienbuch - Seite 2)(Anlage 22).rpt
...
**(A0693)** Schüler > Laufbahn > Allgemein > Wiederholer
---
...
**(A0778)** Schlüsselverzeichnisse > Fachgruppen

Zusatzinformationen zu Fächern - berufliches Fach: Legen Sie unter Schlüsselverzeichnisse > Fachgruppen folgenden Eintrag an:

Kürzel | Schlüssel | Bezeichnung
--|--|--
beliebig | ---  | berufliches Fach

Der Bericht fragt die Bezeichnung "berufliches Fach" ab.

Weisen Sie den entsprechenden beruflichen Fächern unter Schlüsselverzeichnisse Fächer in Spalte "Gruppe" den Eintrag "Berufliches Fach" zu.
...
**(A0102)** Abitur > Qualifikation

Um den Projektkurs im jeweiligen Zeitraum auszugeben, tragen Sie unter Abitur > Qualifikation z.B. bei Q1 (bzw. bei Q2 oder Q3)** das jeweilige Notenkürzel "P" ein.
...
Für die Ausgabe der Noten für Arbeits- und Sozialverhalten  beachten Sie bitte, dass Sie die Grade der Bewertung "vorbildlich", "gut", "zufriedenstellend"  und "entwicklungsbedürftig" im Schlüsselverzeichnis > Noten anlegen müssen.  Das Kürzel kann beliebig gewählt werden, als Notenart tragen Sie "Füllwert" an.
...
Kürzel |  Schlüssel | Bezeichnung	
--|--|--
WahlPF | WahlPF | Teilnahme an Arbeitsgemeinschaften
Pflicht | Pflicht | Pflichtfächer
Pflicht2 | Pflicht 2 | Pflichtfächer 2 zeilig ausgegeben
...
--|--
Lern  | Lernverhalten
Schule  | Verhalten in der Schule
...
Zeugnisse werden immer im 2 HJ eines Schuljahres ausgedruckt! Die Wahlpflichtfächer werden für das erste und zweite Halbjahr ausgegeben!
...
## MVP-GY-AS (Jahrgangsstufe 9-10).rpt
...
**(A0193)** Abitur > Qualifikation

Die Abschlussnote der abgewählten bzw. abgeschlossenen Fächer tragen Sie im Menü Abitur > Qualifikation in dem Feld "E1" ein (siehe auch A0015.53 / A0194). Beachten Sie dabei, Noten anstatt Punkte zu vergeben ("03" wird
dabei z.B. als "3" ausgegeben).

**(A0194)** Abitur > Qualifikation > Merkmal

Den Zeitraum "von" und "bis" der abgewählten bzw. abgeschlossenen Fächer tragen Sie im Menü Abitur > Qualifikation im Feld "Merkmal" ein (siehe auch A0015.53 / A0193). Bitte beachten Sie dabei, nur die letzen beiden Ziffern
des jeweiligen Kalenderjahres hintereinander einzutragen.
...
**(A0195)** Schlüsselverzeichnisse > Fächer > Aufgabenbereich
...
## MVP-GY-AZ (Wahlpflicht allgemein).rpt

## MVP-GY-HJZ (Seite 2 mit Noten).rpt
...
## MVP-GY-JZ (nächste Stufe Wahlpflicht 1. u. 2. HJ).rpt
...
## MVP-GY-JZ (Seite 2 mit Noten).rpt
...
## MVP-GY-JZ (Wahlpflicht allgemein).rpt

## MVP-GY-ÜZ (gleiche Stufe Wahlpflicht 1. + 2. HJ).rpt

## MVP-GY-ÜZ (gleiche Stufe Wahlpflicht allgemein).rpt

## MVP-GY-ÜZ (nächste Stufe Seite1 Lernentwicklungsbericht und Seite 2 mit Noten).rpt
...
## MVP-GY-ÜZ (nächste Stufe Wahlpflicht 1. + 2. HJ).rpt

## MVP-GY-ÜZ (Seite 2 mit Noten).rpt
...
## MVP-REG (Seite 2 mit Noten)-Wappen.rpt

## MVP-REG (Seite 2 mit Noten).rpt
...
**(A0222)** Schüler > Zeugnis > Leistungen

Fächer, denen keine Note zugewiesen wurde, werden nicht ausgegeben.

**(A0225)** Schüler > Zeugnis > Fächer > Merkmal (B oder M)
...
## MVP-REG-HJZ (Bemerkung Gesamteinschätzung).rpt
...
**(A0209)** Schüler > Zeugnis > Fächer > Merkmal
...
## MVP-REG-HJZ (Gesamteinschätzung).rpt
