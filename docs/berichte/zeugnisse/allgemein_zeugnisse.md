...
Tragen Sie Fächer im Menü `Schüler > Zeugnis > Fächer` und die Noten des Schülers im `Schüler > Zeugnis > Leistungen` ein. Es werden die Fächer und Noten des aktuellen und vorherigen Zeitraums ausgegeben.

**Klassen Beurteilungsart** `Klassen > Daten > Beurteilungsart`
