...
Was|Eingabe unter
--|--
Schule|`Mandant > Daten > Name1, Name2, Name2`
Name| `Schueler > Daten1` (Vorname, 2.Vorname, Zusatz, Nachname)
Geboren am<br/>Geburtsort|`Schueler > Daten1` Geburtsdatum, Geburtsort
...
## Fächer, Positionen und Noten

### Endnote

`Schüler > Zeugnis > Leistungen > Endnote`

Bitte erfassen Sie die Noten im Feld `Endnote`.
...
Wahlpflichtfach fünf oder Informationstechnischen Grundkurs (links)| 34
Wahlpflichtfach sechs oder Informationstechnischen Grundkurs(rechts)| 35
...
Die Bemerkung "Entsprechend dem Beschluss der Schulkonferenz  wird das Arbeits- und Sozialverhalten - in der Anlage zu diesem Zeugnis berurteilt - nicht beurteilt-." wird vom Bericht automatisch eingetragen.
