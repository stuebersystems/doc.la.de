...
Die Schwerpunkte werden als Unterrichtsthema ausgegeben.
...
Bitte weisen Sie im Menü Schüler > Zeugnis > Fächer die Fächer zu.

## Fachstatus

`Schüler > Zeugnis > Fächer`

Fracgen Sie im AFchstaus die Werte `1PF` und `2PF` für das 1. und 2. Prüfungsfach ein.

## Bemerkungen

`Schueler > Zeugnis > Bemerkungen / Formluare > Zeugnisbemerkungen`

Es werden nur die Zeugnisbemerkungen des Schülers ausgegeben, die unter Merkmal keinen Eintrag haben haben.
