...
Gemäß Landesverordnung über die Gestaltung der Oberstufe und der Abiturprüfung in den Gymnasien und Gemeinschaftsschulen [(OAPVO) vom 23.10.2020](   https://www.gesetze-rechtsprechung.sh.juris.de/bssh/document/jlr-GymOAbiPrOSH2021pIVZ).
...
Bitte markieren Sie das als Profilseminar gewählte Fach mit der Unterrichtsart `PS`. Ausnahme: Für Schüler, für die das Fach `Informatik`  profilgebendes Fach (Unterrichtsart `P-Kurs`) und Prüfungsfach ist, muss kein weiteres Fach als Profilseminar markiert werden.
